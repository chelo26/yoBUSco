...
public class AddCommentActivity extends Activity implements android.view.View.OnClickListener {
	...
	class AddComment extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... argss) {
            ...
            params.add(new AbstractMap.SimpleEntry("id_event", argss[0]));
	        params.add(new AbstractMap.SimpleEntry("username", argss[1]));
	        params.add(new AbstractMap.SimpleEntry("comment_date", argss[2]));
	        params.add(new AbstractMap.SimpleEntry("comment_text", argss[3]));
