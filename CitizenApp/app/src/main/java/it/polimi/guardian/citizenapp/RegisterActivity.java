...
public class RegisterActivity extends Activity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(credentialsAlreadySaved()){
            ...
            Log.d("Credentials file{}:","proceed to registration");
        }
    ...
    public void onClick(View v) {
        ...
        switch(v.getId())
        {
            ...
            case R.id.btn_signup:
                ...
                {
                    //////////////TEMPORARY DISABLE NUMBER VERIFICATION//////////
                    onVerificationSucess(userNm, phone);
                    ///////////////////////////////////
//                    disableSignUp();
...
//                    });
    ...
    private void onVerificationSucess(String userNm, String phone){
        enableSignUp();
        checkAndSaveUser(userNm, Cognalys.getCountryCode(RegisterActivity.this)+ phone);
    }
    ...
    protected Boolean credentialsAlreadySaved()
    {
        ...
        try{
            ...
            e.printStackTrace();
            Log.d("RA - Error: ",e.getMessage());
            Log.d("RA - jsonCredentials: ",jsonStringCredentials);
        }
    ...
    class CheckUser extends AsyncTask<String, String, String>
    {
        ...
        protected String doInBackground(String... args) {
            ...
            if(success==1)
            {
                ...
                params.add(new AbstractMap.SimpleEntry("username", argss[1]));
                params.add(new AbstractMap.SimpleEntry("phone_number", argss[0]));
                json = JSONParser.makeHttpRequest(url_add_user, "GET", params);
                pom=1;
                ...
                params.add(new AbstractMap.SimpleEntry("phone_number", argss[0]));
                params.add(new AbstractMap.SimpleEntry("username", argss[1]));
                json = JSONParser.makeHttpRequest(url_check_user, "POST", params);//here we send user's phone and check if he is in the database.
